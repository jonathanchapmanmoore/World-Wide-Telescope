...
namespace Microsoft.Research.Science.Data
{
    ...
    /// </para>
    /// <para>The <see cref="DataSetUri"/> class makes verifying and parsing of DataSet URIs and provides methods
    ...
    public class DataSetUri : Uri
    {
        ...
        /// </remarks>
        /// <exception cref="ArgumentException"><see cref=" null"/> or empty string specified as any of the parameters</exception>
        ...
        public static void NormalizeFileNames(DataSetUri uri)
        {
            ...
            foreach (var prop in properties)
            {
                ...
                if (!String.IsNullOrEmpty(file))
                {
                    ...
                    if (!isLocalFile) continue; // not a local file path
                    if (System.IO.Path.IsPathRooted(file)) continue; // it is already full path
