...
namespace Microsoft.Windows.Controls
{
    public class WizardPage : ContentControl
    {
        ...
        public static readonly DependencyProperty NextCommandProperty = DependencyProperty.Register("NextCommand", typeof(ICommand), typeof(WizardPage));
        public ICommand NextCommand
        {
            get { return (ICommand)base.GetValue(NextCommandProperty); }
            set { base.SetValue(NextCommandProperty, value); }
        }

        public static readonly DependencyProperty PreviousCommandProperty = DependencyProperty.Register("PreviousCommand", typeof(ICommand), typeof(WizardPage));
        public ICommand PreviousCommand
        {
            get { return (ICommand)base.GetValue(PreviousCommandProperty); }
            set { base.SetValue(PreviousCommandProperty, value); }
        }
