    ...
    public class Wizard : ItemsControl
    {
        ...
        private void ExecuteSelectNextPage(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            if (CurrentPage != null)
            {
                ...
                if (this.CurrentPage.NextCommand != null)
                {
                    this.CurrentPage.NextCommand.Execute(this.CurrentPage);
                }
            }
        ...
        private void CanExecuteSelectNextPage(object sender, CanExecuteRoutedEventArgs e)
        {
            if (CurrentPage != null)
            {
                ...
                else if (CurrentPage.NextCommand != null)
                {
                    e.CanExecute = this.CurrentPage.NextCommand.CanExecute(this.CurrentPage);
                }
        ...
        private void ExecuteSelectPreviousPage(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            if (CurrentPage != null)
            {
                ...
                if (this.CurrentPage.PreviousCommand != null)
                {
                    this.CurrentPage.PreviousCommand.Execute(this.CurrentPage);
                }
            }
        ...
        private void CanExecuteSelectPreviousPage(object sender, CanExecuteRoutedEventArgs e)
        {
            if (CurrentPage != null)
            {
                ...
                else if (CurrentPage.PreviousCommand != null)
                {
                    e.CanExecute = this.CurrentPage.PreviousCommand.CanExecute(this.CurrentPage);
                }
